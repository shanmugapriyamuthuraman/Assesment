...
import Img1 from "@/assets/NonFictionImg1.png";
import Img2 from "@/assets/NonFictionImg2.png";
import Img3 from "@/assets/NonFictionImg3.png";
import Img4 from "@/assets/NonFictionImg4.png";
import Img5 from "@/assets/NonFictionImg5.png";

const books: { id: string; title: string; author: string; cover: StaticImageData }[] = [
  { id: "psychology-of-money", title: "The Psychology of Money", author: "Morgan Housel", cover: Img1 },
  { id: "richest-man-babylon", title: "The Psychology of Money", author: "Morgan Housel", cover: Img2 },
  { id: "know-this-story",     title: "The Psychology of Money", author: "Morgan Housel", cover: Img3 },
  { id: "million-to-one",      title: "The Psychology of Money", author: "Morgan Housel", cover: Img4 },
  { id: "a-girl-named-harper", title: "The Psychology of Money", author: "Morgan Housel", cover: Img5 },
  { id: "psychology-of-money", title: "The Psychology of Money", author: "Morgan Housel", cover: Img3 },
  { id: "richest-man-babylon", title: "The Psychology of Money", author: "Morgan Housel", cover: Img1 },
];
  ...
  return (
    <section className="py-6 px-6">
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-base font-bold text-gray-900">Non Fiction Books</h2>
