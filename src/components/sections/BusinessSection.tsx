...
import Img1 from "@/assets/BusinessImg1.png";
import Img2 from "@/assets/BusinessImg2.png";
import Img3 from "@/assets/BusinessImg3.png";
import Img4 from "@/assets/BusinessImg4.png";
import Img5 from "@/assets/BusinessImg5.png";

const books: { id: string; title: string; author: string; cover: StaticImageData }[] = [
  { id: "second-biggest-biz",    title: "The Psychology of Money", author: "Morgan Housel", cover: Img1 },
  { id: "international-business", title: "The Psychology of Money", author: "Morgan Housel", cover: Img2 },
  { id: "start-your-own-business", title: "The Psychology of Money", author: "Morgan Housel", cover: Img3 },
  { id: "second-biggest-biz",    title: "The Psychology of Money", author: "Morgan Housel", cover: Img4 },
  { id: "international-business", title: "The Psychology of Money", author: "Morgan Housel", cover: Img5 },
  { id: "start-your-own-business", title: "The Psychology of Money", author: "Morgan Housel", cover: Img3 },
  { id: "second-biggest-biz",    title: "The Psychology of Money", author: "Morgan Housel", cover: Img1 },
];
  ...
  return (
    <section className="py-6 px-6">
      <div className="flex items-center justify-between mb-1">
        <h2 className="text-base font-bold text-gray-900">Business</h2>
